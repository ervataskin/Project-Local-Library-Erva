function findAccountById(accounts, id) {
  ...
  let foundAccount = accounts.find((acct) => {
    return acct.id === id;
  })
  return foundAccount;
}
...
function sortAccountsByLastName(accounts) {
  ...
  accounts.sort(function(a, b){return (a.name.last.localeCompare(b.name.last))});
  return accounts;
}
...
function getAccountFullNames(accounts) {
  ...
  let fullNameArr = accounts.map(a => {return a.name.first + " " + a.name.last});
  return fullNameArr;
}
